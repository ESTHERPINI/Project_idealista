...
ridge_training_score=ridge.score(X_train , y_train)*100
training_score.append(ridge_training_score.mean())
st.write("Training Accuracy: ", ridge.score(X_train , y_train)*100)

ridge_testing_score=ridge.score(X_train , y_train)*100
...
ridge_testing_score=kn.score(X_train , y_train)*100
